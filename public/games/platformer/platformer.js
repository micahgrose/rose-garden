...
function drawJumpPads(){
    ...
    for(let pad of jumpPads){
        ...
        ctx.beginPath(); ctx.roundRect(pad.x-camera.x,pad.y-camera.y+5,pad.width,pad.height,[10]); ctx.stroke();
        ctx.strokeRect(pad.x+20-camera.x,pad.y-camera.y+5,10,pad.stickHeight);
        ctx.beginPath(); ctx.roundRect(pad.x-camera.x,pad.y-camera.y+5,pad.width,pad.height,[10]); ctx.fill();
        ctx.fillRect(pad.x+20-camera.x,pad.y-camera.y+5,10,pad.stickHeight);
    }
}
